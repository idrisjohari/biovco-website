  ...
  return (
    <div style={{ background: C.black, padding: '14px 0', overflow: 'hidden' }}>
      <div style={{
        ...
        {['Tiroid', 'Resdung', 'Tonsil', 'Kolesterol', 'Psoriasis', 'Kencing Manis', 'Sembelit', 'Tekanan Darah Tinggi', 'Migrain', 'Berat Badan'].flatMap(t => [t, t, '']).map((t, i) => (
          <span key={i} style={{
            fontFamily: F.sans,
            fontSize: 11,
            fontWeight: 500,
            ...
            <span style={{ color: C.black, marginRight: 18 }}>·</span>{t.toUpperCase()}
          </span>
        ))}
      </div>
